        ...
        <article className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            <a
              target="_blank"
              href={
                "https://wa.me/5551999999999?Olá vim pelo site e gostaria de mais informações"
              }
              className="bg-green-500 px-5 py-2 rounded-md font-semibold flex items-center justify-center w-fit gap-2" data-aos="fade-up"
            >
