...
const services = [
  ...
  },
  {
    ...
    description:
      "Serviço de hospedagem para animais de estimação, ideal para quando o tutores precisam viajar ou se ausentar por alguns dias. Os pets ficam acomodados em espaços seguros, confortáveis.",
    duration: "1h",
    price: "R$60",
    icon: <Hotel />,
    linkText:
                ...
                >
                  <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                    ...
                    <div className="border-t border-gray-700 pt-4 flex items-center justify-between">
                      ...
                      <a
                        target="_blank"
              href={'https://wa.me/5551999999999?Olá vim pelo site e gostaria de mais informações sobre ${item.title}'}
